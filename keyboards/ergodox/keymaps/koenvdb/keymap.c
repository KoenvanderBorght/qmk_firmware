 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | OSL4 | F12  | CtShB| TL2 | MOML2 |                                       |  MOML1| TL1 |ALTSHIFTF|CTLTAB| Hyper|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | TAB  | LCTL |       |  -   |   *  |
 *                                 ,------|------|------|       |------+--------+------.
 ...
 */
        ...
        [0] = KEYMAP(KC_ESCAPE, KC_1, KC_2, KC_3, KC_4, KC_5, LCTL(KC_X), KC_DELETE, KC_Q, KC_W, KC_E, KC_R, KC_T, LCTL(KC_C), MO(3), KC_A, KC_S, KC_D, KC_F, KC_G, KC_LSHIFT, CTL_T(KC_Z), KC_X, KC_C, KC_V, KC_B, LCTL(KC_V), OSL(4), KC_F12, LCTL(LSFT(KC_B)), TG(2), MO(2), KC_TAB, KC_LCTL, KC_LGUI, KC_SPACE, KC_BSPACE, KC_LALT, LALT(KC_F4), KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINUS, LCTL(LGUI(KC_RIGHT)), KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLASH, KC_H, KC_J, KC_K, KC_L, KC_SCOLON, KC_QUOTE, LCTL(LGUI(KC_LEFT)), KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, KC_LSHIFT, MO(1), TG(1), LALT(LSFT(KC_F)), LCTL(KC_TAB), ALL_T(KC_NO), KC_KP_MINUS, KC_KP_ASTERISK, KC_KP_PLUS, KC_EQUAL, KC_TAB, KC_ENTER),
        ...
        [4] = KEYMAP(LALT(KC_F4), LCTL(KC_1), LCTL(KC_2), LCTL(KC_3), LCTL(KC_4), LCTL(KC_5), KC_TRANSPARENT, LCTL(LSFT(KC_B)), LCTL(LSFT(KC_P)), LCTL(KC_W), LCTL(KC_T), KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LSFT(KC_F12), LCTL(KC_A), LCTL(KC_TAB), LCTL(LSFT(KC_TAB)), KC_TRANSPARENT, KC_TRANSPARENT, LCTL(LSFT(KC_S)), LCTL(KC_S), LCTL(KC_N), LCTL(KC_O), KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LCTL(LSFT(KC_G)), KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT),
